...
import com.ict.edu04.service.AjaxMembersServie;
...
public class AjaxDBController {
	...
	public String getAjaxList2() {
		// Spring에서 json을 만들거나 파싱랄 때는 여러가지 라이브러리르 사용할 수 있다.
		// 그 중 gson이라는 라이브러리르 사용하자 (pom.xml에 등록)
	...
	public String getAjaxIdChk(HttpServletRequest request) {
		...
		String result = ajaxMembersServie.getMemberIdChk(m_id);
	...
	@ResponseBody
	// 파라미터 값은 Vo로 한번에 받아올 수 있다.
	public String getAjaxMemberJoin(MembersVO mvo) {
		String result = ajaxMembersServie.getMemberInsert(mvo);
