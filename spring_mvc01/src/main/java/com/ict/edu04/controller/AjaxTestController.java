...
// 반환형이 String 인 경우 문서 타입이 ContentType="text/html" 로 변경시키자 된다.
...
public class AjaxTestController {
	...
	public String Xml_Exam03() {
		...
		try {
			// 오류 시 Ctrl + shift + f5 누르기
	        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "= JnqKi3mumYAIX6Fj0n25a5egbsJUfRH/iQ2S/aRNtQESw9KhlTLaCPs5Q5xADsSiog9uqbF3JgMzDFpfAF4ANQ=="); /*Service Key*/
...
//	        conn.setRequestProperty("Content-type", "application/json");
	        System.out.println("Response code: " + conn.getResponseCode()); // 200 나오면 성공
	...
	public String Json_Exam02() {
		...
		try {
			// 웹 상의 존재하는 XML 가져오기
			URL url = new URL("https://makeup-api.herokuapp.com/api/v1/products.json");
			URLConnection conn = url.openConnection();
			br = new BufferedReader(new InputStreamReader(conn.getInputStream()));
