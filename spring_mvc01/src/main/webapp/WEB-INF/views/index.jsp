...
<body>
    ...
    <h2>이미지 보기</h2>
    <!-- 이미지 보는 법 4가지 -->
    <img src="/resources/images/bear.jpg" alt="bear" style="width: 100px;"><br>
    <img src="resources/images/bear.jpg" alt="bear" style="width: 100px;"><br>
    <!-- 이미지 태그라이브러리 사용해서 보는 법 -->
    <!-- 추천 : 어플리케이션 컨텍스트 경로가 변경되어도 이미지 경로를 올바르게 참조  -->
    <img src='<c:url value="/resources/images/bear.jpg" />' alt="bear" style="width: 100px;"><br>
    <img src='<c:url value="resources/images/bear.jpg" />' alt="bear" style="width: 100px;"><br>
    
    <!-- 파일 업로드 -->
    <!-- cos 라이브러리 받아서 사용 : pom.xml -->
    <h2>파일 업로드-1</h2>
    ...
    <!-- 
    	...
    	ㅠㅏ일업로드용 클래스 등록 사용하면 cos 라이브러리를 활용한 업/다운로드 불가
    -->
	<h2>파일 업로드-2</h2>
    ...
    <p><a href="/ajax_test_xml">Ajax XML 연습하는 장소이동</a></p>
    <p><a href="/ajax_test_json">Ajax JSON 연습하는 장소이동</a></p>
    <p><a href="/ajax_test_DB">Ajax DB 연습하는 장소이동</a></p>
    <p><a href="/emp">동적 연습 장소로 이동</a></p>
    <p><a href="/email">이메일 연습 장소로 이동</a></p>
    <p><a href="/loginForm">로그인 창으로 이동</a></p>
